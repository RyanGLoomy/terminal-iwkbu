...
export default function LoketLoading() {
  return (
    <section className="space-y-6">
      {/* Header */}
      <div>
        <div className="h-7 w-56 bg-base-200/70 rounded mb-2" />
        <div className="h-4 w-80 bg-base-200/70 rounded" />
      </div>
      ...
      <Card>
        <CardContent className="flex flex-row items-center justify-between pt-5">
          <div className="flex-1">
            <div className="h-5 w-48 bg-base-200/70 rounded mb-2" />
            <div className="h-4 w-64 bg-base-200/70 rounded" />
          </div>
          <div className="flex gap-2">
            <div className="h-8 w-24 bg-base-200/70 rounded" />
            <div className="h-8 w-24 bg-base-200/70 rounded" />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="pt-5">
          <div className="h-5 w-40 bg-base-200/70 rounded mb-4" />
