   ...
   return (
      <section className="space-y-6">
         <div className="space-y-5">
            {/* Heading */}
            <div>
               <div className="h-7 w-64 bg-base-200 rounded skeleton-shimmer mb-2" />
            ...
            <div className="space-y-4">
               ...
               <div className="flex gap-3 p-4 border border-base-300 rounded-lg bg-base-200/50">
                  <div className="h-10 w-48 bg-base-200 rounded skeleton-shimmer" />
                  <div className="h-10 w-48 bg-base-200 rounded skeleton-shimmer" />
                  <div className="h-10 w-32 bg-base-200 rounded skeleton-shimmer" />
               </div>
