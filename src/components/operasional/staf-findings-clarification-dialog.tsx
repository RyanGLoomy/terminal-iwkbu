...
export function StafFindingsClarificationDialog({
   ...
   const [activeTab, setActiveTab] = useState<"klarifikasi" | "tindakan">("klarifikasi");
      ...
      >
         <DialogContent className="max-w-lg">
            <DialogHeader>
             ...
             <div className="flex gap-1 border-b border-base-300 pb-2">
                <button
             ...
             {activeTab === "klarifikasi" && finding?.status !== "closed" && (
                <div className="space-y-3 rounded-lg border border-base-300 bg-base-200/50 p-3">
                   <Textarea
                      ...
                      placeholder="Tulis klarifikasi untuk PO…"
                      rows={3}
                   />
                   <Input
                   ...
                   >
                      ...
                      Kirim Klarifikasi ke PO
                   </Button>
                </div>
             )}

             {activeTab === "klarifikasi" && finding?.status === "closed" && (
                <div className="rounded-md border border-emerald-200 bg-emerald-50 dark:border-green-800 dark:bg-green-950/50 px-3 py-2 text-sm text-success">
                         ...
                         <li key={action.id} className="flex items-start gap-2">
                            ...
                            <div className="flex-1 min-w-0">
                               ...
                               <p className="text-xs text-base-content/70 mt-0.5">
                                  ...
                                  {action.status === "done" &&
                                     action.done_at &&
                                     ` — selesai ${formatDateTime(action.done_at)}`}
                               </p>
                            </div>
                         </li>
                      ))}
